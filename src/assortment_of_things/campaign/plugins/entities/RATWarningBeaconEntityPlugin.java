...
public class RATWarningBeaconEntityPlugin extends BaseCustomEntityPlugin {
...
//		glowAngle2 = 0f;
	...
	public void appendToCampaignTooltip(TooltipMakerAPI tooltip, VisibilityLevel level) {
		...
		if (entity.hasTag(RATTags.getTAG_OUTPOST_WARNING_BEACON()))
		{
			...
			label.setHighlightColors(entity.getFaction().getBaseUIColor());
		}
