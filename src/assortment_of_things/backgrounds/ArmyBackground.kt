...
class ArmyBackground : BaseCharacterBackground() {
    ...
    fun getTooltip(tooltip: TooltipMakerAPI) {
        ...
        var label = tooltip.addPara(
                "The amount of maximum officers within your fleet is doubled, but their maximum level is reduced by 2, and they can no longer receive elite skills. " +
        ...
        label.setHighlight("doubled", "2", "can no longer receive elite skills", "10", "20", "35", "50")
