...
class ForceBackground : BaseCharacterBackground() {
    ...
    override fun getLongDescription(factionSpec: FactionSpecAPI?, factionConfig: NexFactionConfig?): String {
        return "Small ships excel within your fleet, but the use of larger craft is severely limited."
    }
    ...
    fun getTooltip(tooltip: TooltipMakerAPI) {
        ...
        var label = tooltip!!.addPara(
                ...
                "They also receive a 20% increase in maximum speed and maneuverability, 10% improved fire rate and flux dissipation, and have armor increased by 15%. \n\n" +
                "" +
                "Since your expertise is suited to smaller hulls, cruiser and capital class ships within your fleet are almost entirely unuseable. This also applies to logistical ships.", 0f)
