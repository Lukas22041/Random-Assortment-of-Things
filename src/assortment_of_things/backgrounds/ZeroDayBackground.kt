...
class ZeroDayBackground : BaseCharacterBackground() {
    ...
    fun getTooltip(tooltip: TooltipMakerAPI) {
        ...
        var label = tooltip!!.addPara(
                "Any ship below or at 35 deployment points on the opponents side can be temporarily taken control of by pressing right click while hovering over them. \n\n" +
                        "The maximum duration is between 10 to 20 seconds, based on how many deployment points the targeted ship has. The ability has a 20 second cooldown. \n\n" +
                        "" +
                        "While you are controlling the targeted ship, your own ship is on autopilot.", 0f)


        label.setHighlight("35", "taken control", "right click", "10 to 20", "deployment points", "20", "autopilot")
