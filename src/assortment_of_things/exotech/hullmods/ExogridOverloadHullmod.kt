...
class ExogridOverloadHullmod : BaseHullMod() {
    ...
    override fun applyEffectsBeforeShipCreation(hullSize: ShipAPI.HullSize?, stats: MutableShipStatsAPI?, id: String?) {
        stats!!.zeroFluxMinimumFluxLevel.modifyFlat(id, 0.20f)
    ...
    override fun addPostDescriptionSection(tooltip: TooltipMakerAPI, hullSize: ShipAPI.HullSize?,  ship: ShipAPI?, width: Float, isForModSpec: Boolean) {
        ...
        tooltip.addPara("The ships exogrid is forced to run semi-actively for the entire deployment. This allows the ship to gain the zero-flux boost while it is below 20%% of its flux capacity. Additionaly it further amplifies the grids effect on timeflow by another 10%%", 0f,
        Misc.getTextColor(), Misc.getHighlightColor(), "zero-flux boost", "20%", "timeflow", "10%")

        tooltip.addSpacer(10f)

        tooltip.addPara("If the ship is phased, it receives an 2x increase in the soft flux dissipation and weapon recharge rate.", 0f,
        Misc.getTextColor(), Misc.getHighlightColor(), "2x")
