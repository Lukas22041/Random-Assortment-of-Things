...
public class GenesisFrigateDemEffect implements BeamEffectPlugin { //WithReset {

    public static Color STANDARD_RIFT_COLOR = new Color(178, 36, 69,255);
    ...
    public static String RIFTCASCADE_MINELAYER = "rat_genesis_frigate_dem_minelayer";
...
//	}
    ...
    public GenesisFrigateDemEffect() {
