...
public class FlickerUtilV2Abyssal {
	...
	public FlickerUtilV2Abyssal() {
		this(4f);
	}

	public FlickerUtilV2Abyssal(float maxWait) {
	...
	public static void main(String[] args) {
		FlickerUtilV2Abyssal test = new FlickerUtilV2Abyssal();
